...
const translations = {
  en: {
    ...
    stat_1_val: "100% Offline",
    stat_1_lbl: "Works without internet",
    stat_2_val: "No Ads",
    stat_2_lbl: "Zero tracking or sales",
    stat_3_val: "9 Spheres",
    stat_3_lbl: "Harmonious Balance",
  ...
  ru: {
    ...
    stat_1_val: "Офлайн 24/7",
    stat_1_lbl: "Работает без интернета",
    stat_2_val: "Без рекламы",
    stat_2_lbl: "Данные не передаются",
    stat_3_val: "9 Сфер",
    stat_3_lbl: "Гармония жизни",
    stat_4_val: "8 Языков",
    stat_4_lbl: "По всему миру",
